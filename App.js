...
app.patch("/document/:id", authenticateToken, async (req, res, next) => {
    try {
        ...
        const doc = {
            ...
            ...(req.body.data.sent_reviewer_date) && { sent_reviewer_date: req.body.data.sent_reviewer_date },
            ...(req.body.data.sent_approver_date) && { sent_approver_date: req.body.data.sent_approver_date },
            ...(req.body.data.reviewed_with_comments_date) && { reviewed_with_comments_date: req.body.data.reviewed_with_comments_date },
            // name: req.body.data.name, //req.file.originalname,
